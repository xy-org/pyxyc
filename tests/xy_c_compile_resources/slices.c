...
slices_AllSlice slices_slice(void) {
...
slices_IntSlice slices_slice__int__int__int(int32_t start, int32_t end, int32_t step) {
    return (slices_IntSlice){start, end, step};
}

slices_IntSlice slices_slice__int__int(int32_t end, int32_t step) {
    return (slices_IntSlice){0, end, step};
}

slices_IntSlice slices_slice__int(int32_t step) {
    return (slices_IntSlice){0, slices_max__int(), step};
}
...
void slices_testIntSlices(void) {
    ...
    const slices_IntSlice d = slices_slice__int__int__int(1, x, y);
...
slices_Date slices_max__Date(void) {
    return (slices_Date){slices_max__long()};
}

slices_DateSlice slices_slice__Date__Date__Date(slices_Date start, slices_Date end, slices_Date step) {
    return (slices_DateSlice){start, end, step};
}

slices_DateSlice slices_slice__Date__Date(slices_Date end, slices_Date step) {
    return (slices_DateSlice){(slices_Date){0}, end, step};
}

slices_DateSlice slices_slice__Date(slices_Date step) {
    return (slices_DateSlice){(slices_Date){0}, slices_max__Date(), step};
}
...
void slices_testDataSlices(void) {
    ...
    const slices_DateSlice a = slices_slice__Date__Date__Date(today, tomorrow, (slices_Date){1});
    const slices_DateSlice b = slices_slice__Date__Date__Date(tomorrow, today, (slices_Date){-1});
    const slices_DateSlice d = slices_slice__Date__Date(tomorrow, (slices_Date){1});
}
