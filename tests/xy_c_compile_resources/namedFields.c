...
void namedFields_test(void) {
    ...
    const namedFields_Person l_p3 = {namedFields_string((int8_t*)"Johnny", 6), namedFields_string((int8_t*)"Cash", 4)};
    const namedFields_Person l_p4 = {namedFields_string((int8_t*)"Johnny", 6), namedFields_string((int8_t*)"Cash", 4), 71, 1.88, true};
    const namedFields_Person l_p5 = {(namedFields_String){0}, (namedFields_String){0}, 71, 0, true};
    const namedFields_Person l_p6 = {namedFields_string((int8_t*)"Jonny", 5), namedFields_string((int8_t*)"Cash", 4), 0, 0, true};
    const namedFields_Person l_p7 = {namedFields_string((int8_t*)"Johnny", 6), namedFields_string((int8_t*)"Cash", 4), 71};
    ...
    tmp_1.m_firstName = namedFields_string((int8_t*)"Jonny", 5);
    tmp_1.m_lastName = namedFields_string((int8_t*)"Cash", 4);
    const namedFields_Person l_p10 = tmp_1;
    l_p1.m_firstName = namedFields_string((int8_t*)"Johnny", 6);
    l_p1.m_age = 71;
