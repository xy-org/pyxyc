...
stringInterpolation_Str stringInterpolation_to(stringInterpolation_StrBuilder* builder) {
    stringInterpolation_Str res = (stringInterpolation_Str){builder->xy_addr, builder->xy_size};
    return res;
}
...
void stringInterpolation_createStrings() {
    const float pi = 3.1415f;

    stringInterpolation_StrBuilder __tmp0 = stringInterpolation_fstr("string", 6);
    stringInterpolation_Str str1 = stringInterpolation_to(&__tmp0);
    stringInterpolation_StrBuilder __tmp1 = stringInterpolation_fstr("str1={str1}", 12);
    stringInterpolation_append(&__tmp1, str1);
    stringInterpolation_Str str2 = stringInterpolation_to(&__tmp1);
}
