...
void forgettingTags1_call__1(forgettingTags1_Struct p_s) {
}

void forgettingTags1_call__2(forgettingTags1_Struct p_s) {
}

void forgettingTags1_call__3(forgettingTags1_Struct p_s) {
}
...
void forgettingTags1_test(void) {
    ...
    forgettingTags1_call__1(l_s1);
    forgettingTags1_call__2(l_s2);
    forgettingTags1_call__3(l_s3);
    forgettingTags1_call__3(l_s1);
    forgettingTags1_call__3(l_s2);
    forgettingTags1_call__1(l_s3);
    forgettingTags1_call__2(l_s3);
}
