...
void defaultValue_func__Data__Tag1(defaultValue_Data p_data) {
}

void defaultValue_func__Data__Tag2(defaultValue_Data p_data) {
}

void defaultValue_func__Data__MissingTag(defaultValue_Data p_data) {
}

void defaultValue_test(void) {
    defaultValue_Data l_a = {0};
    defaultValue_func__Data__Tag2(l_a);
    defaultValue_Data l_b = {0};
    defaultValue_func__Data__MissingTag(l_b);
}
