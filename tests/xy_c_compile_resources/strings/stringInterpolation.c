...
void stringInterpolation_append__1(stringInterpolation_StrBuilder* p_builder, stringInterpolation_Str p_str) {
}

void stringInterpolation_append__2(stringInterpolation_StrBuilder* p_builder, float p_f, int32_t p_precision) {
}

void stringInterpolation_append__3(stringInterpolation_StrBuilder* p_builder, void* p_addr, uint64_t p_size) {
}
...
void stringInterpolation_createStrings(void) {
    ...
    stringInterpolation_append__3(&tmp_0_fstr, (int8_t*)"string", 6);
    ...
    stringInterpolation_append__3(&tmp_1_fstr, (int8_t*)"str1=", 5);
    stringInterpolation_append__1(&tmp_1_fstr, l_str1);
    ...
    stringInterpolation_append__3(&tmp_2_fstr, (int8_t*)"str1=", 5);
    stringInterpolation_append__1(&tmp_2_fstr, l_str1);
    ...
    stringInterpolation_append__2(&tmp_3_fstr, l_pi, 6);
    ...
    stringInterpolation_append__2(&tmp_4_fstr, l_pi * 2, 6);
    ...
    stringInterpolation_append__2(&tmp_5_fstr, l_pi, 2);
    ...
    stringInterpolation_append__2(&tmp_6_fstr, l_pi, 2);
    ...
    stringInterpolation_append__3(&tmp_7_fstr, (int8_t*)"pi=", 3);
    stringInterpolation_append__2(&tmp_7_fstr, l_pi, 2);
    ...
    stringInterpolation_append__3(&tmp_8_fstr, (int8_t*)"Test{f};\n", 9);
