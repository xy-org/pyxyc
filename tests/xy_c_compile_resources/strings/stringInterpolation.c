...
void stringInterpolation_createStrings(void) {
    ...
    stringInterpolation_StrBuilder tmp_0_fstr = stringInterpolation_fstr("string", 6);
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_0_fstr, "string", 6);
    const stringInterpolation_Str l_str1 = stringInterpolation_to(&tmp_0_fstr);
    stringInterpolation_StrBuilder tmp_1_fstr = stringInterpolation_fstr("str1={str1}", 11);
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_1_fstr, "str1=", 5);
    ...
    stringInterpolation_StrBuilder tmp_2_fstr = stringInterpolation_fstr("{=str1}", 7);
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_2_fstr, "str1=", 5);
    ...
    stringInterpolation_StrBuilder tmp_3_fstr = stringInterpolation_fstr("{pi}", 4);
    ...
    stringInterpolation_StrBuilder tmp_4_fstr = stringInterpolation_fstr("{pi * 2}", 8);
    ...
    stringInterpolation_StrBuilder tmp_5_fstr = stringInterpolation_fstr("{pi, 2}", 7);
    ...
    stringInterpolation_StrBuilder tmp_6_fstr = stringInterpolation_fstr("{pi, precision=2}", 17);
    ...
    stringInterpolation_StrBuilder tmp_7_fstr = stringInterpolation_fstr("{=pi, precision=2}", 18);
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_7_fstr, "pi=", 3);
    ...
    stringInterpolation_StrBuilder tmp_8_fstr = stringInterpolation_fstr("Test{f};\n", 9);
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_8_fstr, "Test{f};\n", 9);
