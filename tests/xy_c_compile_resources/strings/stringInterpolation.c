...
void stringInterpolation_createStrings(void) {
    ...
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_0_fstr, (int8_t*)"string", 6);
    ...
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_1_fstr, (int8_t*)"str1=", 5);
    ...
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_2_fstr, (int8_t*)"str1=", 5);
    ...
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_7_fstr, (int8_t*)"pi=", 3);
    ...
    stringInterpolation_append__StrBuilder__Ptr__Size(&tmp_8_fstr, (int8_t*)"Test{f};\n", 9);
