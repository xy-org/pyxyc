...
int32_t positionalTags_sizeof__with__int(void) {
    return 4;
}

int32_t positionalTags_sizeof__with__Point(void) {
    return 8;
}
...
int32_t positionalTags_test(void) {
    ...
    return positionalTags_len(ints) + positionalTags_len(points) + positionalTags_sizeof__with__int() + positionalTags_sizeof__with__Point();
}
