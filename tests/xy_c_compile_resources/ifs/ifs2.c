...
int32_t ifs2_test3(int32_t p_num) {
    ...
    if (p_num > 0) {
        ...
        int32_t tmp_3_arg = ifs2_helper1();
        int32_t tmp_4_arg = ifs2_helper1();
        tmp_2 = ifs2_compute(tmp_3_arg, tmp_4_arg, ifs2_helper1());
    } else {
        int32_t tmp_5_arg = ifs2_helper3();
        int32_t tmp_6_arg = ifs2_helper2();
        tmp_2 = ifs2_compute(tmp_5_arg, tmp_6_arg, ifs2_helper1());
    }
    return tmp_2;
}
