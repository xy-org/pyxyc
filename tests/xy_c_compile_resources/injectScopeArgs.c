...
void injectScopeArgs_fun(int32_t p_a, float p_b, injectScopeArgs_MyStruct p_c) {
}
...
void injectScopeArgs_test5(double p_d, injectScopeArgs_MyStruct p_c) {
    ...
    injectScopeArgs_fun(l_a, l_b, p_c);
}
