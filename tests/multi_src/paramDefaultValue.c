...
int32_t paramDefaultValue_module1_fun(int32_t p_a, int32_t p_b) {
    return p_a + p_b;
}

void paramDefaultValue_module1_test(void) {
    paramDefaultValue_module1_fun(5, paramDefaultValue_module1_calcDefaultValue(5));
    paramDefaultValue_module1_fun(5, 10);
}
...
void paramDefaultValue_test(void) {
    const int32_t l_a = 5;
    paramDefaultValue_module1_fun(l_a, paramDefaultValue_module1_calcDefaultValue(l_a));
    paramDefaultValue_module1_fun(l_a, 10);
    paramDefaultValue_module1_fun(l_a * 10, paramDefaultValue_module1_calcDefaultValue(l_a * 10));
